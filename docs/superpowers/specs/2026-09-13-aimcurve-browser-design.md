# aimcurve in the browser, read-only
...
[live updates](2026-09-13-aimcurve-live-updates-design.md); getting a *watchable*
folder out of a default install is
[reaching the install](2026-09-13-aimcurve-reaching-the-install.md). Neither is
...
`aimcurve/web/` is already static — `app.js`, `style.css`, a vendored uPlot, no
...
- ~~Non-Windows.~~ Answered from Chromium's blocklist source: Linux's default
  ...
  [reaching the install](2026-09-13-aimcurve-reaching-the-install.md).
