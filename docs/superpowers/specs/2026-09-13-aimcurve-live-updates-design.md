...
the way `python -m aimcurve` does today.
...
Depends on [the read-only browser app](2026-09-13-aimcurve-browser-design.md) for
the source boundary and the incremental index path, and on
[reaching the install](2026-09-13-aimcurve-reaching-the-install.md) for how a
...
- Whether the observer survives the target being replaced wholesale — relevant
  if [reaching the install](2026-09-13-aimcurve-reaching-the-install.md) ends up
