...
[step one](2026-09-13-aimcurve-browser-design.md) is not subject to the
...
[step one](2026-09-13-aimcurve-browser-design.md): Linux users are Tier 1 by
...
not. `%USERPROFILE%\aimcurve-data` works and is the least surprising choice.
...
Worth noting for [step two](2026-09-13-aimcurve-live-updates-design.md): if a
...
Default-path users get [step one](2026-09-13-aimcurve-browser-design.md) only:
